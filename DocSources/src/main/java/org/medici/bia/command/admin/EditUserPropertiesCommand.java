/*
 * EditUserPropertiesCommand.java
 *
...
public class EditUserPropertiesCommand {
	...
	/**
	 * @return the expirationPassword
	 */
	public String getExpirationPassword() {
		return expirationPassword;
	}

	/**
	 * @param expirationPassword the expirationPassword to set
	 */
	public void setExpirationPassword(String expirationPassword) {
	...
	/**
	 * @return the maxBadLogin
	 */
	public String getMaxBadLogin() {
		return maxBadLogin;
	}
	
	/**
	 * @param maxBadLogin the maxBadLogin to set
	 */
	public void setMaxBadLogin(String maxBadLogin) {
		this.maxBadLogin = maxBadLogin;
	}
