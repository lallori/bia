 ...
 */
@Entity
@Table ( name = "\"tblVettingHistory\"" ) 
public class VettingHistory implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2560408875985306766L;

	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	@Column (name="\"idVettingHistory\"", length=10, nullable=false)
	private Integer idVettingHistory;
	 ...
	 * @param document
	 */
	public VettingHistory(User user, String description, Action action, Category category, Object object) {
	...
	/**
	 * @param idVettingHistory the idVettingHistory to set
	 */
	public void setIdVettingHistory(Integer idVettingHistory) {
		this.idVettingHistory = idVettingHistory;
	}

	/**
	 * @return the idVettingHistory
	 */
	public Integer getIdVettingHistory() {
		return idVettingHistory;
	}
