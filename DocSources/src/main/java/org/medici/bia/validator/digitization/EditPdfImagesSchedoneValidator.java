/*
 * EditPdfImagesSchedoneValidator.java
 * 
...
import org.medici.bia.command.digitization.EditPdfImagesSchedoneCommand;
 ...
 * 
 */
public class EditPdfImagesSchedoneValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditPdfImagesSchedoneCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditPdfImagesSchedoneCommand editPdfImagesSchedoneCommand = (EditPdfImagesSchedoneCommand) object;
		editPdfImagesSchedoneCommand.getSchedoneId();
