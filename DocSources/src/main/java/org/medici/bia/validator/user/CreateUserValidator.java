 ...
 * 
 */
public class CreateUserValidator extends AbstractUserValidator implements Validator {
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(CreateUserCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		...
		validateAccount(createCommand.getAccount(), errors);
	}
}
