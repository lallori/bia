/*
 * EditEmailPropertiesValidator.java
 * 
...
/**
 * Validator bean for action "Edit Email Properties Validator".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditEmailPropertiesValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditEmailPropertiesCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		// EditEmailPropertiesCommand editEmailPropertiesCommand = (EditEmailPropertiesCommand) object;
