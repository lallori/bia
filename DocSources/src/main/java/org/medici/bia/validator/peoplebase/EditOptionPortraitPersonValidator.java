/*
 * EditOptionPortraitPersonValidator.java
 *
 ...
 *
 */
public class EditOptionPortraitPersonValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditOptionPortraitPersonCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditOptionPortraitPersonCommand editOptionPortraitPersonCommand = (EditOptionPortraitPersonCommand) object;
		validatePersonId(editOptionPortraitPersonCommand.getPersonId(), errors);
	}
