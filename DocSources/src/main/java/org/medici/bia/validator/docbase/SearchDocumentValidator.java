...
/**
 * Validator bean for action "Search Document".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class SearchDocumentValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(SearchDocumentCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		//SearchDocumentCommand searchDocumentCommand = (SearchDocumentCommand) object;
