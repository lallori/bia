...
import org.medici.bia.command.user.UnregisterUserCommand;
 ...
 * 
 */
public class UnregisterUserValidator extends AbstractUserValidator implements Validator {
	@Autowired
	 ...
	 * validator supports only DeleteUserCommand.
	 * 
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(UnregisterUserCommand.class);
	}
