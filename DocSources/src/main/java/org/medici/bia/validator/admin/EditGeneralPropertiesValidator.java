/*
 * EditGeneralPropertiesValidator.java
 * 
...
import org.medici.docsources.command.admin.EditGeneralPropertiesCommand;
...
/**
 * Validator bean for action "Edit General Properties Validator".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditGeneralPropertiesValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditGeneralPropertiesCommand.class);
	}
