/*
 * EditCorrespondentsVolumeValidator.java
 * 
...
/**
 * Validator bean for action "Edit Correspondents Volume".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditCorrespondentsVolumeValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditCorrespondentsVolumeCommand.class);
	}
