/*
 * EditRecaptchaPropertiesValidator.java
 * 
...
import org.medici.bia.command.admin.EditRecaptchaPropertiesCommand;
...
/**
 * Validator bean for action "Edit Recaptcha Properties Validator".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditRecaptchaPropertiesValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditRecaptchaPropertiesCommand.class);
	}
