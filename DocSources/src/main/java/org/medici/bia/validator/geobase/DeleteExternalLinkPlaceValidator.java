/*
 * DeleteExternalLinkPlaceValidator.java
 * 
...
/**
 * Validator bean for action "Delete External Link Place".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class DeleteExternalLinkPlaceValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(DeleteExternalLinkPlaceCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		DeleteExternalLinkPlaceCommand deleteExternalLinkPlaceCommand = (DeleteExternalLinkPlaceCommand) object;
		validatePlaceId(deleteExternalLinkPlaceCommand.getPlaceExternalLinksId(), deleteExternalLinkPlaceCommand.getPlaceAllId(), errors);
	}
	 ...
	 * @param errors
	 */
	public void validatePlaceId(Integer placeExternalLinksId, Integer placeAllId, Errors errors) {
			...
			try {
				...
				if (place == null) {
					...
					if (externalLinks == null) {
						errors.reject("placeExternalLinksId", "error.placeExternalLinksId.null");
					}

					if (!externalLinks.contains(new PlaceExternalLinks(placeExternalLinksId))) {
						errors.reject("placeExternalLinksId", "error.placeExternalLinksId.null");
					}
				}
