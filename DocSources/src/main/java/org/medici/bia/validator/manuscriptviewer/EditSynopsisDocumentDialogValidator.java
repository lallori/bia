/*
 * EditSynopsisDocumentDialogValidator.java
 * 
 ...
 * 
 */
public class EditSynopsisDocumentDialogValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditSynopsisDocumentDialogCommand.class);
	}
