/*
 * DeletePortraitPersonValidator.java
 * 
...
/**
 * Validator bean for action "Delete Portrait Person".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class DeletePortraitPersonValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(DeletePortraitPersonCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		DeletePortraitPersonCommand deletePortraitPersonCommand = (DeletePortraitPersonCommand) object;
		validateDeleteOperation(deletePortraitPersonCommand.getPersonId(), errors);
	}
