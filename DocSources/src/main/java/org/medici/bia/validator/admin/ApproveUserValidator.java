...
/**
 * Validator bean for action "Approve User Validator".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class ApproveUserValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(ApproveUserCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		ApproveUserCommand approveUserCommand = (ApproveUserCommand) object;
