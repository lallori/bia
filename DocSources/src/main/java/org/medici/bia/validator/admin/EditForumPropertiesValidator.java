/*
 * EditForumPropertiesValidator.java
 * 
...
import org.medici.bia.command.admin.EditForumPropertiesCommand;
...
/**
 * Validator bean for action "Edit Forum Properties".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditForumPropertiesValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditForumPropertiesCommand.class);
	}
