/*
 * ShowAccessLogSearchValidator.java
 * 
 ...
 * 
 */
public class ShowAccessLogSearchValidator implements Validator {
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(ShowAccessLogSearchCommand.class);
	}
