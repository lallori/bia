/*
 * DeleteMotherPersonValidator.java
 * 
...
import org.medici.bia.command.peoplebase.DeleteMotherPersonCommand;
...
/**
 * Validator bean for action "Delete Mother from Person".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class DeleteMotherPersonValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(DeleteMotherPersonCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		DeleteMotherPersonCommand deleteMotherPersonCommand = (DeleteMotherPersonCommand) object;
		validateMother(deleteMotherPersonCommand.getId(), deleteMotherPersonCommand.getParentId(), errors);
	}
	 ...
	 * @param errors
	 */
	public void validateMother(Integer id, Integer motherId, Errors errors) {
		...
		if (!errors.hasErrors()) {
			try {
				...
				if (parent == null) {
					errors.reject("personId", "error.parentId.notfound");
				} else {
					if (motherId != null) {
						if (parent.getParent() == null) {
							errors.reject("mother", "error.motherId.notfound");
						} else if (!parent.getParent().getPersonId().equals(motherId)) {
							errors.reject("mother", "error.motherId.notfound");
						}
					}
				}
