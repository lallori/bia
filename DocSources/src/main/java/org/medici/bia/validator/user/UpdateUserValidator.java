...
import org.medici.bia.command.user.UpdateUserCommand;
 ...
 * 
 */
public class UpdateUserValidator extends AbstractUserValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(UpdateUserCommand.class);
	}
