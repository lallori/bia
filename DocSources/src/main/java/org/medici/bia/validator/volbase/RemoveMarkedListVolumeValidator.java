/*
 * RemoveMarkedListVolumeValidator.java
 * 
...
import org.medici.bia.command.volbase.RemoveMarkedListVolumeCommand;
...
/**
 * Validator bean for action "Remove Marked List Volume".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * @author Matteo Doni (<a href=mailto:donimatteo@gmail.com>donimatteo@gmail.com</a>)
 * 
 */
public class RemoveMarkedListVolumeValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(RemoveMarkedListVolumeCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		RemoveMarkedListVolumeCommand removeMarkedListVolumeCommand = (RemoveMarkedListVolumeCommand) object;
		validateVolume(removeMarkedListVolumeCommand.getSummaryId(), errors);
		validateRemoveMarkedList(removeMarkedListVolumeCommand.getSummaryId(), errors);
	}
	...
	public void validateRemoveMarkedList(Integer summaryId, Errors errors) {
		if(!errors.hasErrors()){
			try{
				...
				if(userMarkedList != null){
					if(!getUserMarkedListService().ifVolumeAlreadyPresent(userMarkedList, summaryId)){
						errors.reject("summaryId", "error.volume.notInMarked");
					}
				}
			}catch(ApplicationThrowable ath){
				errors.reject("summaryId", "error.volume.notInMarked");
