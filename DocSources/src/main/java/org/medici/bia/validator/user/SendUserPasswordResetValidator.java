...
import org.medici.bia.command.user.SendUserPasswordResetCommand;
...
public class SendUserPasswordResetValidator extends AbstractUserValidator implements Validator {
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(SendUserPasswordResetCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		SendUserPasswordResetCommand sendUserOrPasswordCommand = (SendUserPasswordResetCommand) object;
