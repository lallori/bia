/*
 * EditTiffImagesSchedoneValidator.java
 * 
 ...
 * 
 */
public class EditTiffImagesSchedoneValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditTiffImagesSchedoneCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditTiffImagesSchedoneCommand editTiffImagesSchedoneCommand = (EditTiffImagesSchedoneCommand) object;
		editTiffImagesSchedoneCommand.getSchedoneId();
