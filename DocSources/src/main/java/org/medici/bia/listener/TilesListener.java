 ...
 */
package org.medici.bia.listener;
...
import org.medici.bia.tiles.ApplicationTilesContainerFactory;
...
public class TilesListener  extends AbstractTilesListener {
    ...
    protected TilesInitializer createTilesInitializer() {
        return new ApplicationTilesInitializer();
    }

    private static class ApplicationTilesInitializer extends AbstractTilesInitializer {

        @Override
        protected AbstractTilesContainerFactory createContainerFactory(TilesApplicationContext context) {
            return new ApplicationTilesContainerFactory();
        }
    }
}
