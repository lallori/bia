/*
 * EditNamesPersonController.java
 * 
...
import org.medici.bia.command.peoplebase.EditNamesPersonCommand;
...
/**
 * Controller for action "Edit Names Person".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 */
@Controller
@RequestMapping("/de/peoplebase/EditNamesPerson")
public class EditNamesPersonController {
	@Autowired
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") EditNamesPersonCommand command, BindingResult result) {
