 ...
 */
@Controller
@RequestMapping("/de/geobase/DeletePlace")
public class DeletePlaceController {
	@Autowired
	private GeoBaseService geoBaseService;
	@Autowired(required = false)
	@Qualifier("deletePlaceValidator")
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") DeletePlaceCommand command, BindingResult result) {
