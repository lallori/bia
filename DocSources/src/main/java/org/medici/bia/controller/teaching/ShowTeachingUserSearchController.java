/*
 * ShowTeachingUserSearchController.java
 *
 ...
 */
@Controller
@RequestMapping("/teaching/ShowTeachingUserSearch")
public class ShowTeachingUserSearchController {
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") ShowTeachingUserSearchCommand command, BindingResult result) {
		...
		if (result.hasErrors()) {
			...
			return new ModelAndView("teaching/TeachingUserSearchResult", model);
		}
	}
