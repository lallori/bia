...
import org.medici.bia.command.volbase.CompareVolumeRequestCommand;
...
/**
 * Controller for action "Compare volume".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 */
@Controller
@RequestMapping("/src/volbase/CompareVolume")
public class CompareVolumeController {
	@Autowired
	...
	public ModelAndView setupForm(@ModelAttribute("requestCommand") CompareVolumeRequestCommand command, BindingResult result) {
		...
		return new ModelAndView("volbase/CompareVolume", model);
	}
