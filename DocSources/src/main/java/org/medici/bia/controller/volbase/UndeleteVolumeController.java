...
import org.medici.bia.command.volbase.UndeleteVolumeCommand;
...
/**
 * Controller for action "Undelete Volume". This controller set volume
...
public class UndeleteVolumeController {
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") UndeleteVolumeCommand command, BindingResult result) {
