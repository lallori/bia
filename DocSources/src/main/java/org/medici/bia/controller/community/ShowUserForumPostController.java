/*
 * ShowUserForumPostController.java
 * 
...
import org.medici.bia.command.community.ShowUserForumPostCommand;
 ...
 */
@Controller
@RequestMapping("/community/ShowUserForumPost")
public class ShowUserForumPostController {
	@Autowired
	...
	public ModelAndView setupForm(@ModelAttribute("command") ShowUserForumPostCommand command, HttpSession httpSession) {
