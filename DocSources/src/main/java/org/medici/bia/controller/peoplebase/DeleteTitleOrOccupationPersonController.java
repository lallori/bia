/*
 * DeleteTitleOrOccupationPersonController.java
 * 
...
/**
 * Controller for action "Delete Name Person". This controller deletes
 * link between a person and a specific name.
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 */
@Controller
@RequestMapping("/de/peoplebase/DeleteTitleOrOccupationPerson")
public class DeleteTitleOrOccupationPersonController {
	@Autowired
	private PeopleBaseService peopleBaseService;

	@Autowired(required = false)
	@Qualifier("deleteTitleOrOccupationPersonValidator")
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") DeleteTitleOrOccupationPersonCommand command, BindingResult result) {
