...
public class EditExtractOrSynopsisDocumentCommand {
	...
	private Boolean manuscriptViewer;
	...
	/**
	 * @param manuscriptViewer the manuscriptViewer to set
	 */
	public void setManuscriptViewer(Boolean manuscriptViewer) {
		this.manuscriptViewer = manuscriptViewer;
	}

	/**
	 * @return the manuscriptViewer
	 */
	public Boolean getManuscriptViewer() {
		return manuscriptViewer;
	}
