/*
 * EditParentsPersonValidator.java
 *
 ...
 *
 */
public class EditParentsPersonValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditParentsPersonCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditParentsPersonCommand editParentsPersonCommand = (EditParentsPersonCommand) object;
		validateFather(editParentsPersonCommand.getFatherRecordId(), editParentsPersonCommand.getFatherPersonId(), errors);
		validateMother(editParentsPersonCommand.getMotherRecordId(), editParentsPersonCommand.getMotherPersonId(), errors);
	}
