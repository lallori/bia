 ...
 *
 */
public class EditResearchNotesPersonValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditResearchNotesPersonCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditResearchNotesPersonCommand editResearchNotesPersonCommand = (EditResearchNotesPersonCommand) object;
		validatePersonId(editResearchNotesPersonCommand.getPersonId(), errors);
	}
