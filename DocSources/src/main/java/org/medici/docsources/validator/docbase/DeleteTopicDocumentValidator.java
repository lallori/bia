/*
 * DeleteTopicDocumentValidator.java
 * 
...
/**
 * Validator bean for action "Delete Topic Document".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class DeleteTopicDocumentValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(DeleteTopicDocumentCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		DeleteTopicDocumentCommand deleteTopicDocumentCommand = (DeleteTopicDocumentCommand) object;
		validateDocumentId(deleteTopicDocumentCommand.getEplToId(), deleteTopicDocumentCommand.getEntryId(), errors);
	}
	 ...
	 * @param errors
	 */
	public void validateDocumentId(Integer eplToId, Integer entryId, Errors errors) {
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "eplToId", "error.eplToId.null");
