...
import org.medici.docsources.command.user.LockUserCommand;
 ...
 * 
 */
public class LockUserValidator extends AbstractUserValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(LockUserCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		...
		validateAccount(lockUserCommand.getAccount(), errors);
	}
}
