...
/**
 * Validator bean for action "Edit Correspondents Or People Document".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditCorrespondentsOrPeopleDocumentValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditCorrespondentsOrPeopleDocumentCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditCorrespondentsOrPeopleDocumentCommand editCorrespondentsOrPeopleDocumentCommand = (EditCorrespondentsOrPeopleDocumentCommand) object;
		validateDocumentId(editCorrespondentsOrPeopleDocumentCommand.getDocumentId(), errors);
	}
