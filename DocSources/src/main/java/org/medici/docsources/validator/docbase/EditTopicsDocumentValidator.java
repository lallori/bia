/*
 * EditTopicsDocumentValidator.java
 * 
...
/**
 * Validator bean for action "Edit Topics Document".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditTopicsDocumentValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditTopicsDocumentCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditTopicsDocumentCommand modifyDocumentCommand = (EditTopicsDocumentCommand) object;
		validateDocumentId(modifyDocumentCommand.getDocumentId(), errors);
	}
