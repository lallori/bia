/*
 * EditTitleOrOccupationValidator.java
 * 
...
public class EditTitleOrOccupationValidator implements Validator {
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditTitleOrOccupationCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		EditTitleOrOccupationCommand editTitleOrOccupationCommand = (EditTitleOrOccupationCommand) object;
		validateTitleId(editTitleOrOccupationCommand.getTitleOccId(), errors);
	}
	 ...
	 * @param errors
	 */
	public void validateTitleId(Integer titleOccId, Errors errors) {
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "titleOccId", "error.titleOccIdNew.null");
