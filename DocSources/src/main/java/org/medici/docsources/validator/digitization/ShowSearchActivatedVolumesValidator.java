/*
 * ShowSearchActivatedVolumesValidator.java
 * 
...
/**
 * Validator bean for action "Search Activated Volumes".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * @author Matteo Doni (<a href=mailto:donimatteo@gmail.com>donimatteo@gmail.com</a>)
 * 
 */
public class ShowSearchActivatedVolumesValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(ShowSearchActivatedVolumesCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		ShowSearchActivatedVolumesCommand showSearchActivatedVolumesCommand = (ShowSearchActivatedVolumesCommand) object;
		validateFields(showSearchActivatedVolumesCommand.getSearchType(), showSearchActivatedVolumesCommand.getVolNum(), showSearchActivatedVolumesCommand.getVolNumBetween(), errors);
