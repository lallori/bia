/*
 * EditExtractOrSynopsisDocumentValidator.java
 * 
...
/**
 * Validator bean for action "Edit Extract Or Synopsis Document".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditExtractOrSynopsisDocumentValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditExtractOrSynopsisDocumentCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		...
		validateDocumentId(editExtractOrSynopsisDocumentCommand.getDocumentId(), errors);
	}
