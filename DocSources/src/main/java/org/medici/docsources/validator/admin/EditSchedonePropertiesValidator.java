/*
 * EditSchedonePropertiesValidator.java
 * 
...
/**
 * Validator bean for action "Edit Schedone Properties Validator".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * 
 */
public class EditSchedonePropertiesValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(EditSchedonePropertiesCommand.class);
	}
