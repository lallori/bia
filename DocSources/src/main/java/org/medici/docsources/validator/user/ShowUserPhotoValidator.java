...
import org.medici.docsources.command.user.ShowUserPhotoCommand;
 ...
 * 
 */
public class ShowUserPhotoValidator extends AbstractUserValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(ShowUserPhotoCommand.class);
	}
