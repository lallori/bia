 ...
 * 
 */
public class ModifyUserValidator extends AbstractUserValidator implements Validator {
	@Autowired
	...
	public boolean supports(Class givenClass) {
		return givenClass.equals(ModifyUserCommand.class);
	}
	...
	public void validate(Object object, Errors errors) {
		...
		// Validation on userAccount
		validateAccount(modifyUserCommand.getAccount(), errors);
	}
