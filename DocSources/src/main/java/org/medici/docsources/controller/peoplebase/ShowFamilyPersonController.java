/*
 * ShowFamilyPersonController.java
 * 
...
import org.medici.docsources.command.peoplebase.ShowFamilyPersonCommand;
...
/**
 * Controller for action "Show family person".
 * 
...
public class ShowFamilyPersonController {
	...
	public ModelAndView setupForm(@ModelAttribute("requestCommand") ShowFamilyPersonCommand command, BindingResult result) {
		...
		return new ModelAndView("peoplebase/ShowFamilyPerson", model);
	}
