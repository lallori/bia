/*
 * EditResearchNotesPersonController.java
 * 
...
/**
 * Controller for action "Edit Research Notes of a Person".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 */
@Controller
@RequestMapping("/de/peoplebase/EditResearchNotesPerson")
public class EditResearchNotesPersonController {
	@Autowired
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") EditResearchNotesPersonCommand command, BindingResult result) {
