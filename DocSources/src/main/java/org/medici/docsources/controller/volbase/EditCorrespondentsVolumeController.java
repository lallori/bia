/*
 * EditCorrespondentsVolumeController.java
 * 
...
/**
 * Controller for action "Edit Correspondents Volume".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 */
@Controller
@RequestMapping("/de/volbase/EditCorrespondentsVolume")
public class EditCorrespondentsVolumeController {
	@Autowired(required = false)
	@Qualifier("editCorrespondentsVolumeValidator")
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") EditCorrespondentsVolumeCommand command, BindingResult result) {
	...
	public ModelAndView setupForm(@ModelAttribute("command") EditCorrespondentsVolumeCommand command) {
		...
		return new ModelAndView("volbase/EditCorrespondentsVolume", model);
	}
