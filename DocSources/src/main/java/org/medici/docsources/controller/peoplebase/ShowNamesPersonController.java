/*
 * ShowNamesPersonController.java
 * 
...
import org.medici.docsources.command.peoplebase.ShowNamesPersonCommand;
 ...
 */
@Controller
@RequestMapping("/src/peoplebase/ShowNamesPerson")
public class ShowNamesPersonController {
	@Autowired
	...
	public ModelAndView setupForm(@ModelAttribute("requestCommand") ShowNamesPersonCommand command, BindingResult result){
		...
		return new ModelAndView("peoplebase/ShowNamesPerson", model);
	}
}