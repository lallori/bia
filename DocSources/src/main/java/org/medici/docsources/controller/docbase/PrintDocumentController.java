...
import org.medici.docsources.command.docbase.PrintDocumentRequestCommand;
...
/**
 * Controller for action "Print Document".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * @author Matteo Doni (<a href=mailto:donimatteo@gmail.com>donimatteo@gmail.com</a>)
 */
@Controller
@RequestMapping("/src/docbase/PrintDocument")
public class PrintDocumentController {
	...
	public ModelAndView processSubmit(@ModelAttribute("requestCommand") PrintDocumentRequestCommand command, BindingResult result) {
		...
		return new ModelAndView("docbase/PrintDocument", model);
	}
