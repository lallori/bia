/*
 * ShowRecipientDocumentsPersonController.java
 * 
 ...
 */
@Controller
@RequestMapping("/de/peoplebase/ShowRecipientDocumentsPerson")
public class ShowRecipientDocumentsPersonController {
	@Autowired
	...
	public ModelAndView setupForm(@ModelAttribute("requestCommand") ShowDocumentsPersonCommand command, BindingResult result) {
		...
		return new ModelAndView("peoplebase/ShowRecipientDocumentsPerson", model);
	}
