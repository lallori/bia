/*
 * ShowDocumentInManuscriptViewerAdvancedController.java
 * 
...
/**
 * Controller for action "Show Document In Manuscript Viewer Advanced".
 * 
 * @author Lorenzo Pasquinelli (<a href=mailto:l.pasquinelli@gmail.com>l.pasquinelli@gmail.com</a>)
 * @author Matteo Doni (<a href=mailto:donimatteo@gmail.com>donimatteo@gmail.com</a>)
 */
@Controller
@RequestMapping("/src/mview/ShowDocumentInManuscriptViewerAdvanced")
public class ShowDocumentInManuscriptViewerAdvancedController {
	@Autowired
	...
	public ModelAndView setupPage(@ModelAttribute("requestCommand") ShowDocumentInManuscriptViewerCommand command, BindingResult result){
		...
		return new ModelAndView("mview/ShowDocumentInManuscriptViewerHtmlAdvanced", model);
	}
