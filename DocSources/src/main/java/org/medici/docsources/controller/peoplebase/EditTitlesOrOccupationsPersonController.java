/*
 * EditTitlesOrOccupationsPersonController.java
 * 
 ...
 */
@Controller
@RequestMapping("/de/peoplebase/EditTitlesOrOccupationsPerson")
public class EditTitlesOrOccupationsPersonController {
	@Autowired
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") EditTitlesOrOccupationsPersonCommand command, BindingResult result) {
