...
import org.medici.docsources.command.user.ModifyUserCommand;
...
/**
 * Controller to permit user modify action.
...
public class ModifyUserController {
	...
	public ModelAndView processSubmit(@Valid @ModelAttribute("command") ModifyUserCommand command, BindingResult result) {
	...
	public ModelAndView setupForm(@ModelAttribute("command") ModifyUserCommand command) {
		Map<String, Object> model = new HashMap<String, Object>();
		User user = null;
		...
		return new ModelAndView("user/ModifyUserOK",model);
	}
