...
public class User implements Serializable {
	...
	public static enum UserRole {
		ADMINISTRATORS("ADMINISTRATORS"), COMMUNITY_USERS("COMMUNITY_USERS"), DIGITIZATION_TECHNICIANS(
		"DIGITIZATION_TECHNICIANS"), DIGITIZATION_USERS(
		"DIGITIZATION_USERS"), DISTANT_FELLOWS("DISTANT_FELLOWS"), GUESTS(
		"GUESTS"), ONSITE_FELLOWS("ONSITE_FELLOWS"), SENIOR_DISTANT_FELLOWS(
		"SENIOR_DISTANT_FELLOWS");
