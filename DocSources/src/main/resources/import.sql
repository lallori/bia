...
INSERT INTO docsources.tblApplicationProperty (id, help, value) VALUES ('iipimage.image.notavailable', 'Tif image name for not available', 'img_notAvailable.tif');
...
INSERT INTO docsources.tblApplicationProperty (id, help, value) VALUES ('mail.forumPostReplyNotification.subject', '', 'bia.medici.org - {0} {1} replied to [{2}]');
INSERT INTO docsources.tblApplicationProperty (id, help, value) VALUES ('mail.forumPostReplyNotification.text', '', 'The Medici Archive Project  - BIA\r\n\r\n{0} {1} replied to your post on topic {2} \r\n\r\nclick on the following link to see it:\r\n\r\n{3}://{4}{5}community/ShowTopicForum.do?forumId={6}&topicId={7}&completeDOM=true');
