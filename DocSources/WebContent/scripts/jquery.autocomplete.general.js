...
(function($) {
  ...
  function AutocompleteGeneral(el, options) {
    this.el = $(el);
  ...
  $.fn.autocompleteGeneral = function(options) {
    return new AutocompleteGeneral(this.get(0)||$('<input />'), options);
  };


  AutocompleteGeneral.prototype = {
