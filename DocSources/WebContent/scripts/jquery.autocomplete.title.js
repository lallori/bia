...
(function($) {
  ...
  function AutocompleteTitle(el, options) {
    this.el = $(el);
  ...
  $.fn.AutocompleteTitle = function(options) {
    return new AutocompleteTitle(this.get(0)||$('<input />'), options);
  };


  AutocompleteTitle.prototype = {
