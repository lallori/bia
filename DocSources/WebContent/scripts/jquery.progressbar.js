	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/DocSourcesProject/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/DocSourcesProject/images/progressbg_red.gif',
									30: '/DocSourcesProject/images/progressbg_orange.gif',
									70: '/DocSourcesProject/images/progressbg_green.gif'
								},
