...
(function($) {
  ...
  function AutocompletePerson(el, options) {
    this.el = $(el);
  ...
  $.fn.autocompletePerson = function(options) {
    return new AutocompletePerson(this.get(0)||$('<input />'), options);
  };


  AutocompletePerson.prototype = {
