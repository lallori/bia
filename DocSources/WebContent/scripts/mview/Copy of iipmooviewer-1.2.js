...
var IIP = new Class({
  ...
  createWindows: function(){
    ...
    new Element('img', {src: '/DocSources/images/mview/help.32x32.png', id: 'info', styles: { opacity: 0.8 } } ).injectInside('logo');

    // Fix IE7 PNG transparency problem
    if( Browser.Engine.trident5 ){
      $('info').setStyle( 'filter', 'progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true,src="/DocSources/images/mview/iip.32x32.png",sizingMethod=scale)' );
    }
