...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags" %>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="display"  id="showRecipientDocumentsPlace">
		...
		<tbody>
			...
			<tr>
				<td><a class="searchResult" href="${ShowDocumentURL}">${currentDocument.entryId}</a></td>
				...
				<td><a class="searchResult" href="${ShowPersonURL}">${currentDocument.recipientPeople.personId}</a></td>
				<td><a class="searchResult" href="${ShowPersonURL}">${currentDocument.recipientPeople.mapNameLf}</a></td>
