...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags" %>
	...
	<div id="yourSearchFilterDiv">
		...
		<form id="yourEasySearchFilterForm" action="${AdvancedSearchURL}" method="post">
			...
			<c:if test="${(not empty searchFilter.filterData.exactName) && ((not empty searchFilter.filterData.names))}"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			<div id="personSearchDiv">
			<c:forEach items="${searchFilter.filterData.exactName}" varStatus="iterator">	
				<div class="searchFilterDiv">
					<span class="categorySearch">Name: </span><span class="wordSearch">${searchFilter.filterData.exactName[iterator.index]}</span><a class="remove" href="#">(remove)</a>
			...
			<c:if test="${(not empty searchFilter.filterData.words) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName))}"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.roleCategories) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.words))}"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.titleOccWord) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.roleCategories))}"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.titlesOcc) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.roleCategories) || (not empty searchFilter.filterData.titleOccWord)) }"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.gender) &&  ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.roleCategories) || (not empty searchFilter.filterData.titleOccWord) || (not empty searchFilter.filterData.titlesOcc)) }"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.place) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.roleCategories) || (not empty searchFilter.filterData.titlesOcc) || (not empty searchFilter.filterData.titleOccWord) || (not empty searchFilter.filterData.gender)) }"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.datesTypes) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.roleCategories) || (not empty searchFilter.filterData.titlesOcc) || (not empty searchFilter.filterData.titleOccWord) || (not empty searchFilter.filterData.gender))}"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.researchNotes) && ((not empty searchFilter.filterData.names) || (not empty searchFilter.filterData.exactName) || (not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.datesTypes) || (not empty searchFilter.filterData.roleCategories) || (not empty searchFilter.filterData.titlesOcc) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.titleOccWord) || (not empty searchFilter.filterData.gender)) }"><hr><p class="andOrNotAdvancedSearchCenter">And</p><hr></c:if>
