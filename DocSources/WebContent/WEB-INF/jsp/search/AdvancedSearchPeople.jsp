...
<p><u>Search People</u></p>
<br />
<div>
	<form id="namePartsSearchForm" method="post" class="edit">
		<label for="namePartsSearch" id="namePartsSearchLabel">Name Parts: <a href="#" class="helpLink">?</a></label>
		<input id="namePartsSearch" name="namePartsSearch" class="input_20c" type="text" value=""/>
		in:
		<select id="inNamePartsSearch" name="inNamePartsSearch" class="selectform_Mlong">
		...
		<a href="#" id="addNamePartsSearch">Add</a>
	</form>	
</div>

<div>
	<form id="wordSearchForm" method="post" class="edit">
		<label for="dateRangeSearch" id="dateRangeSearchLabel">Date Range: <a href="#" id="helpLink">?</a></label>
		<select id="dateRangeSearch" name="dateRangeSearch" class="selectform_Mlong">
		...
		<input id="yearDateRangeSearch" name="yearDateRangeSearch" class="input_4c" type="text" value="year" maxlength="4"/>
		<select id="monthDateRangeSearch" name="monthDateRangeSearch" class="selectform">
		...
		<input id="dayDateRangeSearch" name="dayDateRangeSearch" class="input_2c" type="text" value="day" maxlength="2"/>
...
<div>
	<form id="genderSearchForm" method="post" class="edit">
		<label for="genderSearch" id="genderSearchLabel">Gender: <a href="#" id="helpLink">?</a></label>
		<select id="genderSearch" name="genderSearch" class="selectform_Xlong">
		...
		<a href="#" id="addGenderSearch">Add</a>
	</form>
</div>

<div>
	<form id="placeSearchForm" method="post" class="edit">
		<label for="placeSearch" id="placeSearchLabel">Place: <a href="#" id="helpLink">?</a></label>
