...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags" %>
	...
	<div id="yourSearchFilterDiv">
		...
		<form id="yourEasySearchFilterForm" action="${AdvancedSearchURL}" method="post">
			...
			<c:if test="${(not empty searchFilter.filterData.person) && (not empty searchFilter.filterData.words)}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="personSearchDiv">
			<c:forEach items="${searchFilter.filterData.person}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch">Person: </span><span class="wordSearch">${searchFilter.filterData.person[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.place) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="placeSearchDiv">
			<c:forEach items="${searchFilter.filterData.place}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.place"/>: </span><span class="wordSearch">${searchFilter.filterData.place[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.sender) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="senderSearchDiv">
			<c:forEach items="${searchFilter.filterData.sender}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.sender"/>: </span><span class="wordSearch">${searchFilter.filterData.sender[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.from) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="fromSearchDiv">
			<c:forEach items="${searchFilter.filterData.from}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.senderFrom"/>: </span><span class="wordSearch">${searchFilter.filterData.from[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.recipient) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="recipientSearchDiv">
			<c:forEach items="${searchFilter.filterData.recipient}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.recipient"/>: </span><span class="wordSearch">${searchFilter.filterData.recipient[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.to) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="toSearchDiv">
			<c:forEach items="${searchFilter.filterData.to}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.recipientTo"/>: </span><span class="wordSearch">${searchFilter.filterData.to[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.refersTo) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="refersToSearchDiv">
			<c:forEach items="${searchFilter.filterData.refersTo}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.refersTo"/>: </span><span class="wordSearch">${searchFilter.filterData.refersTo[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(not empty searchFilter.filterData.extract) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="extractSearchDiv">
			<c:forEach items="${searchFilter.filterData.extract}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.transcription"/>: </span><span class="wordSearch">${searchFilter.filterData.extract[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
					<input type="hidden" value="${fn2:encode(searchFilter.filterData.extract[iterator.index])}" name="extract">
				</div>
				<c:if test="${!iterator.last}"><p class="andOrNotAdvancedSearch"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p></c:if>
			</c:forEach>
			</div>
			<c:if test="${(not empty searchFilter.filterData.synopsis) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo) || (not empty searchFilter.filterData.extract))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="synopsisSearchDiv">
			<c:forEach items="${searchFilter.filterData.synopsis}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.synopsis"/>: </span><span class="wordSearch">${searchFilter.filterData.synopsis[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
					<input type="hidden" value="${fn2:encode(searchFilter.filterData.synopsis[iterator.index])}" name="synopsis">
				</div>
				<c:if test="${!iterator.last}"><p class="andOrNotAdvancedSearch"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p></c:if>
			</c:forEach>
			</div>
			<c:if test="${(not empty searchFilter.filterData.topics) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo) || (not empty searchFilter.filterData.extract) || (not empty searchFilter.filterData.synopsis))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="topicSearchDiv">
			<c:forEach items="${searchFilter.filterData.topics}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.topic"/>: </span><span class="wordSearch">${searchFilter.filterData.topics[iterator.index]} <i>${searchFilter.filterData.topicsPlace[iterator.index]}</i></span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
...
<%-- 			<c:if test="${(not empty searchFilter.filterData.topicsPlace) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo) || (not empty searchFilter.filterData.extract) || (not empty searchFilter.filterData.synopsis) || (not empty searchFilter.filterData.topics))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if> --%>
...
<!-- 			</div> -->
			...
			<c:forEach items="${searchFilter.filterData.datesTypes}" varStatus="iterator">
				<div class="searchFilterDiv">
					...
					<c:if test="${searchFilter.filterData.datesTypes[iterator.index] == 'From'}"><span class="wordSearch">${searchFilter.filterData.datesYear[iterator.index]} ${months[searchFilter.filterData.datesMonth[iterator.index]]} ${searchFilter.filterData.datesDay[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
					...
					<c:if test="${searchFilter.filterData.datesTypes[iterator.index] == 'Between'}"><span class="wordSearch">${searchFilter.filterData.datesYear[iterator.index]} ${months[searchFilter.filterData.datesMonth[iterator.index]]} ${searchFilter.filterData.datesDay[iterator.index]} , ${searchFilter.filterData.datesYearBetween[iterator.index]} ${months[searchFilter.filterData.datesMonthBetween[iterator.index]]} ${searchFilter.filterData.datesDayBetween[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
					<c:if test="${searchFilter.filterData.datesTypes[iterator.index] == 'InOn'}"><span class="wordSearch">${searchFilter.filterData.datesYear[iterator.index]} ${months[searchFilter.filterData.datesMonth[iterator.index]]} ${searchFilter.filterData.datesDay[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.volumes) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo) || (not empty searchFilter.filterData.extract) || (not empty searchFilter.filterData.synopsis) || (not empty searchFilter.filterData.topics) || (not empty searchFilter.filterData.datesTypes))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			...
			<c:forEach items="${searchFilter.filterData.volumes}" varStatus="iterator">
				<div class="searchFilterDiv">
					...
					<c:if test="${searchFilter.filterData.volumesTypes[iterator.index] == 'Exactly'}"><span class="wordSearch">${searchFilter.filterData.volumes[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
					<c:if test="${searchFilter.filterData.volumesTypes[iterator.index] == 'Between'}"><span class="wordSearch">${searchFilter.filterData.volumes[iterator.index]}, ${searchFilter.filterData.volumesBetween[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.folios) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo) || (not empty searchFilter.filterData.extract) || (not empty searchFilter.filterData.synopsis) || (not empty searchFilter.filterData.topics) || (not empty searchFilter.filterData.datesTypes) || (not empty searchFilter.filterData.volumes))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			...
			<c:forEach items="${searchFilter.filterData.folios}" varStatus="iterator">
				<div class="searchFilterDiv">
					...
					<c:if test="${searchFilter.filterData.foliosTypes[iterator.index] == 'Exactly'}"><span class="wordSearch">${searchFilter.filterData.folios[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
					<c:if test="${searchFilter.filterData.foliosTypes[iterator.index] == 'Between'}"><span class="wordSearch">${searchFilter.filterData.folios[iterator.index]}, ${searchFilter.filterData.foliosBetween[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a></c:if>
			...
			<c:if test="${(not empty searchFilter.filterData.folioMods) && ((not empty searchFilter.filterData.words) || (not empty searchFilter.filterData.person) || (not empty searchFilter.filterData.place) || (not empty searchFilter.filterData.sender) || (not empty searchFilter.filterData.from) || (not empty searchFilter.filterData.recipient) || (not empty searchFilter.filterData.to) || (not empty searchFilter.filterData.refersTo) || (not empty searchFilter.filterData.extract) || (not empty searchFilter.filterData.synopsis) || (not empty searchFilter.filterData.topics) || (not empty searchFilter.filterData.datesTypes) || (not empty searchFilter.filterData.volumes) || (not empty searchFilter.filterData.folios))}"><hr><p class="andOrNotAdvancedSearchCenter"><fmt:message key="search.advancedSearchDocumentsFilter.andBoolean"/></p><hr></c:if>
			<div id="folioModSearchDiv">
			<c:forEach items="${searchFilter.filterData.folioMods}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.folioAddenda"/>: </span><span class="wordSearch">${searchFilter.filterData.folioMods[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:forEach items="${searchFilter.filterData.docIds}" varStatus="iterator">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.docId"/>:</span><span class="wordSearch">${searchFilter.filterData.docIds[iterator.index]}</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
			...
			<c:if test="${(searchFilter.filterData.logicalDelete != null)}">
				<div class="searchFilterDiv">
					<span class="categorySearch"><fmt:message key="search.advancedSearchDocumentsFilter.logicalDelete"/>:</span><span class="wordSearch">Yes</span><a class="remove" href="#"><fmt:message key="search.advancedSearchDocumentsFilter.remove"/></a>
