...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags" %>
	...
	<div id="EditTitlesOrOccupationsPersonDiv" class="background">
		<div class="title">
			<h5><fmt:message key="peoplebase.showTitlesOrOccupationsPerson.titlesOccupations"/> </h5>
			<security:authorize ifAnyGranted="ROLE_ADMINISTRATORS, ROLE_ONSITE_FELLOWS, ROLE_FELLOWS">
		...
		<div class="list">
			<c:forEach items="${person.poLink}" var="currentPoLink">
				...
				<div class="row">
					...
					<div class="info"><fmt:message key="peoplebase.showTitlesOrOccupationsPerson.start"/> ${currentPoLink.startDate} | <fmt:message key="peoplebase.showTitlesOrOccupationsPerson.end"/> ${currentPoLink.endDate}</div>
				</div>
			</c:forEach>
		</div>
	</div>
