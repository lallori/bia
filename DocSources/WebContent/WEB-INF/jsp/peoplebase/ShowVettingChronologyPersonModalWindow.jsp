...
<div id="vettingHistoryTableDiv">
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="vettingHistoryTable">
        <thead>
            <tr>
                <th><fmt:message key=“people.showVettingChronologyPersonModalWindow.date”/></th>
                <th><fmt:message key=“people.showVettingChronologyPersonModalWindow.action”/></th>
                <th><fmt:message key=“people.showVettingChronologyPersonModalWindow.who”/></th>
            </tr>
        </thead>
        <tbody>
            <tr>                                                                                              
                <td colspan="3" class="dataTables_empty"><fmt:message key=“people.showVettingChronologyPersonModalWindow.loadingData”/></td>                        
            </tr> 
        </tbody>
    </table>
</div>
...
<div id="vettingHistoryButtons">
	<a id="close" href="#" title="Close Vetting History window"><fmt:message key=“people.showVettingChronologyPersonModalWindow.close”/></a>
</div>
