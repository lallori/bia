...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags" %>
	...
	<div id="EditTitleOccupationDiv" class="background">
		<div class="title">
			<h5><fmt:message key="peoplebase.showTitleOrOccupation.titlesOccupations"/> </h5>
			<security:authorize ifAnyGranted="ROLE_ADMINISTRATORS, ROLE_ONSITE_FELLOWS, ROLE_FELLOWS">
		...
		<div class="list">
			<div class="row">
				<div class="item37"><fmt:message key="peoplebase.showTitleOrOccupation.titleOccupationName"/></div>
				<div class="value">${titleOccsList.titleOcc}</div>
			</div>
			<div class="row">
				<div class="item37"><fmt:message key="peoplebase.showTitleOrOccupation.role"/></div>
