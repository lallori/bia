...
<c:if test="${person.personId != 0}">
	<div id="topBodyLeftMenuDiv">
		...
		<security:authorize ifAnyGranted="ROLE_ADMINISTRATORS, ROLE_ONSITE_FELLOWS, ROLE_DISTANT_FELLOWS">
			<a id="vettingHistory" class="button_bodyleft_medium" title="<fmt:message key="menu.record.vettinghistory"></fmt:message>" href="${ShowVettingChronologyPersonURL}">Vetting History</a>
		</security:authorize>
		...
		<c:if test="${!person.logicalDelete}">
			<a id="deleteAction" class="button_bodyleft_small" title="<fmt:message key="menu.record.delete"></fmt:message>" href="${DeletePersonURL}">Delete</a>
		</c:if>	
		<c:if test="${person.logicalDelete}">
			<a id="undeleteAction" class="button_bodyleft_small" title="<fmt:message key="menu.record.undelete"></fmt:message>" href="${UndeletePersonURL}">Undelete</a>
		</c:if>	
		</security:authorize>
		...
		<a id="buttonShareLink" class="button_bodyleft_medium2" href="${SharePersonURL}" title="<fmt:message key="menu.record.sharelink"></fmt:message>">Share/Link</a>
	</div>
</c:if>
