...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags"%>
	...
	<form:form id="editOptionPortraitPersonForm" action="${EditOptionPortraitPersonURL}" method="post" class="edit" enctype="multipart/form-data">
		<div class="listForm">
			<div class="row">
				<div class="col_l">
					<form:label for="portraitAuthor" id="portraitAuthorLable" path="portraitAuthor">Author</form:label>
				</div>
				<div class="col_l">
			...
			<div class="row">
				<div class="col_l">
					<form:label for="portraitSubject" id="portraitSubjectLabel" path="portraitSubject">Subject</form:label>
				</div>
				<div class="col_l">
