...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags"%>
	...
	<form:form id="uploadPortraitPersonForm" action="${ShowUploadPortraitPersonURL}"	method="post" class="edit" enctype="multipart/form-data">
		<div class="listForm">
			<div class="row">
				<div class="col_l">
					<form:label for="link" id="linkLabel" path="link"><fmt:message key="peoplebase.showUploadPortraitPersonModalWindow.link"/></form:label>
				</div>
				<div class="col_l">
			...
			<div class="row">
				<div class="col_l">
					<form:label for="browse" id="browseLabel" path="browse"><fmt:message key="peoplebase.showUploadPortraitPersonModalWindow.browse"/></form:label>
				</div>
				<div class="col_l">
		...
		<div>
			...
			<a id="resetPortrait" href="${DeletePortraitPersonURL}" class="button_medium"><fmt:message key="peoplebase.showUploadPortraitPersonModalWindow.resetPortrait"/></a>
