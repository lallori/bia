	...
	<div id="volumeDiv">
		...
		<div id="volumeTitle">
			...
			<c:if test="${volDocsRelated != 0 && volDocsRelated != 1}">
				<p style="margin:10px 0 0 10px;">Documents related to this Volume record: <a id="num_docsCompare" href="${ShowDocumentsVolumeURL}" class="num_docs" title="View all the documents related to this Volume record">${volDocsRelated}</a></p>
			</c:if>
			...
			<c:if test="${volDocsRelated == 1}">
				<p style="margin:10px 0 0 10px;">Documents related to this Volume record: <a id="num_docsCompare" href="${ShowDocumentsVolumeURL}" class="num_docs" title="View the document related to this Volume record">${volDocsRelated}</a></p>
			</c:if>
		</div>
		</c:if>
