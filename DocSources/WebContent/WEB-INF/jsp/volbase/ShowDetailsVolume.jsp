	...
	<div id="volumeDiv">
		...
		<div id="volumeTitle">
			...
			<c:if test="${volDocsRelated != 0 && volDocsRelated != 1}">
				<p style="margin:10px 0 10px 10px;">Documents related to this Volume record: <a href="${ShowDocumentsVolumeURL}" class="num_docs" title="Click here to view all the documents related to this Volume record">${volDocsRelated}</a></p>
			</c:if>
			<c:if test="${volDocsRelated == 0}">
				<p style="margin:10px 0 10px 10px;">Documents related to this Volume record: <span class="num_docs" title="No documents related to this Volume record">0</span></p>
			</c:if>
			<c:if test="${volDocsRelated == 1}">
				<p style="margin:10px 0 10px 10px;">Documents related to this Volume record: <a href="${ShowDocumentsVolumeURL}" class="num_docs" title="Click here to document related to this Volume record">${volDocsRelated}</a></p>
			</c:if>
		</div>
		</c:if>
