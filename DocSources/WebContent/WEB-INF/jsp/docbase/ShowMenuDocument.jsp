...
<%@ taglib prefix="security" uri="http://www.springframework.org/security/tags" %>
	...
	<div id="topBodyLeftMenuDiv">
		...
		<%-- 			<a id="vettingHistory" title="<fmt:message key="menu.record.vettinghistory"></fmt:message>" href="${ShowVettingChronologyDocumentURL}">Vetting History</a> --%>
		</security:authorize>
		...
		<security:authorize ifAnyGranted="ROLE_ADMINISTRATORS, ROLE_ONSITE_FELLOWS, ROLE_DISTANT_FELLOWS">
			<c:if test="${!document.logicalDelete}">
				<a id="deleteAction" title="<fmt:message key="menu.record.delete"></fmt:message>" href="${DeleteDocumentURL}">Delete</a>
			</c:if>	
			<c:if test="${document.logicalDelete}">
				<a id="undeleteAction"  title="<fmt:message key="menu.record.undelete"></fmt:message>" href="${UndeleteDocumentURL}">Undelete</a>
			</c:if>	
		</security:authorize>
